  ...
  try {
    ...
    if (fs.existsSync(mainWorkspace)) {
      ...
      workspaces.push({
        ...
        path: mainWorkspace,
        agentName: mainInfo?.name || 'Moltsa',
      });
    }
    ...
    const mockWorkspaces: Workspace[] = [
      { id: 'workspace', name: 'Main Workspace', emoji: '🦞', path: '/workspace/main', agentName: 'Moltsa' },
      { id: 'workspace-studio', name: 'Studio', emoji: '🎨', path: '/workspace/studio', agentName: 'Studio' },
      { id: 'workspace-scout', name: 'Scout', emoji: '🔭', path: '/workspace/scout', agentName: 'Scout' },
    ];
